...
SECRET_KEY = "django-insecure-vp79+2sd0g6+(x!vyu51^b_sju(&+5g=myb+yekk)-i)x0(=ir"
...
# CORS_ALLOWED_ORIGINS = ["http://localhost:5173", "http://10.0.0.90:5175/"]
...
# WSGI_APPLICATION = 'back_redes_sociales.wsgi.application'
